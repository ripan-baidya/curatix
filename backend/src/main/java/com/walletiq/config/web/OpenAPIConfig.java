...
public class OpenAPIConfig {
    ...
    /**
     * OpenAPI configuration for non-production environment(dev, test etc)
     */
    @Bean
    @Profile("!prod")
        ...
        Info info = new Info()
                ...
                .description(
                        "Documentation for the endpoints provided by the " +
                                ...
                                "An AI-powered expense tracking platform built using Retrieval-Augmented Generation (RAG) to intelligently analyze, " +
                                "retrieve, and generate insights from user expense data. The system enables natural language queries, spending summaries, " +
                                " and context-aware financial insights.\n\n" +
                                authNote
                )
                .contact(new Contact()
    ...
    /**
     * Helper method to create a tag with extensions
     */
