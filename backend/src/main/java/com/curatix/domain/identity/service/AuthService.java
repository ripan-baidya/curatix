package com.curatix.domain.identity.service;

import com.curatix.domain.identity.dto.command.ConfirmResetPasswordCommand;
import com.curatix.domain.identity.dto.command.LoginCommand;
import com.curatix.domain.identity.dto.command.RefreshTokenCommand;
import com.curatix.domain.identity.dto.command.RegisterAccountCommand;
import com.curatix.domain.identity.dto.result.*;
